...
app.post("/api/admin-send-push", async (req,res) => {
  ...
  try {
    ...
    if(!tokens.length){
      return res.json({ success:true, sent:0, message:"No devices registered for push yet." });
    }
    let sentCount = 0;
    let failedCount = 0;
...
app.get("/api/v1/voices", async (req,res) => {
  ...
  return res.json({
    success: true,
    voices: [
      {voice_id:"English_CaptivatingStoryteller",name:"Captivating Storyteller",language:"English",gender:"Female"},
      {voice_id:"English_MaturePartner",name:"Mature Partner",language:"English",gender:"Male"},
      {voice_id:"English_FriendlyPerson",name:"Friendly Person",language:"English",gender:"Female"},
      {voice_id:"English_ReliableMentor",name:"Reliable Mentor",language:"English",gender:"Male"},
      {voice_id:"English_PatiencePatient",name:"Patience",language:"English",gender:"Female"},
      {voice_id:"English_PlayfulSangfroid",name:"Playful",language:"English",gender:"Male"},
      {voice_id:"English_DecisiveMentor",name:"Decisive Mentor",language:"English",gender:"Male"},
      {voice_id:"English_VoiceOfReason",name:"Voice of Reason",language:"English",gender:"Male"},
      {voice_id:"English_WarmthAndCare",name:"Warmth and Care",language:"English",gender:"Female"},
      {voice_id:"English_EasyGoing",name:"Easy Going",language:"English",gender:"Male"},
      {voice_id:"English_SteadfastProtector",name:"Steadfast Protector",language:"English",gender:"Male"},
      {voice_id:"English_Whisper",name:"Whisper",language:"English",gender:"Female"},
      {voice_id:"English_RomanticAura",name:"Romantic Aura",language:"English",gender:"Female"},
      {voice_id:"English_GentleExpression",name:"Gentle Expression",language:"English",gender:"Female"},
      {voice_id:"English_TenderAndCaring",name:"Tender and Caring",language:"English",gender:"Female"},
      {voice_id:"English_ComfortingAngel",name:"Comforting Angel",language:"English",gender:"Female"},
      {voice_id:"English_DelightfulCompanion",name:"Delightful Companion",language:"English",gender:"Female"},
      {voice_id:"English_LeadingMan",name:"Leading Man",language:"English",gender:"Male"},
      {voice_id:"English_BrilliantCoach",name:"Brilliant Coach",language:"English",gender:"Male"},
      {voice_id:"English_SportsCommentator",name:"Sports Commentator",language:"English",gender:"Male"}
    ]
  });
});
...
// ── DEVELOPER PLANS ──
const DEV_PLANS = {
  starter: { name:"Starter", price_usd:15, credits:3000000, label:"3M characters/month" },
  growth: { name:"Growth", price_usd:40, credits:10000000, label:"10M characters/month" },
  pro: { name:"Pro", price_usd:90, credits:20000000, label:"20M characters/month" }
};
